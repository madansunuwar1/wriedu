document.addEventListener("DOMContentLoaded", function () {
  ...
  // Theme Toggle
  // =================================
  const darkLayoutButton = document.querySelector('.dark-layout');
  const lightLayoutButton = document.querySelector('.light-layout');

  darkLayoutButton.addEventListener('click', function() {
    userSettings.Theme = 'dark';
    applySettings();
    saveSettings();
  });

  lightLayoutButton.addEventListener('click', function() {
