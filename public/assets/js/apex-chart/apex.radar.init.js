document.addEventListener("DOMContentLoaded", function () {
  try {
    ...
    if (document.querySelector("#chart-radar-basic")) {
      var options_basic = {
        series: [
          {
            name: "Series 1",
    ...
    if (document.querySelector("#chart-radar-multiple-series")) {
    ...
    if (document.querySelector("#chart-radar-polygon-fill")) {
      var options_polygon = {
        series: [
          {
            name: "Series 1",
    ...
    console.log("Radar chart initialization error:", error);
  }
});