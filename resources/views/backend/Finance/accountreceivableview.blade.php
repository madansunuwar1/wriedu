...
<div class="main-container">
    <div class="widget-content searchable-container list">
        ...
        <div class="invoice-container" id="invoice-container">
            ...
            if (!isset($application->university) || !isset($application->english)) {
                continue;
            }
            ...
            // Calculate commission values if a rule is found
            if ($matchingCommission) {
                $commissionTypes = $matchingCommission->commission_types;
                if (is_string($commissionTypes) && json_decode($commissionTypes, true)) {
                    $commissionTypes = json_decode($commissionTypes, true);
                }
            ...
            // Get transaction details for 'receivable'
            $commissionTransaction = $application->commission_transaction;
            $paidValue = 0;
            $exchangeRate = 1;

            if ($commissionTransaction && isset($commissionTransaction->type) && $commissionTransaction->type === 'receivable') {
                $paidValue = is_numeric($commissionTransaction->paid) ? (float)$commissionTransaction->paid : 0;
                $exchangeRate = is_numeric($commissionTransaction->exchange_rate) ? (float)$commissionTransaction->exchange_rate : 1;
            }
            ...
            <div class="invoice-document" data-appid="{{ $application->id }}"
                ...
                data-commissionpayable-id="{{ optional($application->commission_transaction)->commissionpayable_id }}">
                ...
                <div class="invoice-header">
                    <div class="d-flex justify-content-between w-100">
                        ...
                        <div class="logo-icon">
                            {{-- FIX: Corrected crossorigin attribute --}}
                ...
                <div class="totals-section">
                    <div class="totals-box">
                        ...
                        {{-- FIX: Updated HTML structure to prevent wrapping --}}
...
{{-- UPDATED: CSS from Accounts Payable for perfect A4 printing --}}
<style>
    :root {
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // --- IN-PLACE EDITING SCRIPT (Preserved for Accounts Receivable) ---
        ...
        function confirmAndSaveChanges() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    const appId = container.closest('.invoice-document').dataset.appid;
        ...
        function saveData(appId, field, newValue, originalValue) {
            ...
            const container = invoiceDoc.querySelector(`.editable-field[data-field="${field}"]`);
            if (!container) {
                showError('UI Error: Could not find the field to update.');
                return;
            }
            const commissionPayableId = invoiceDoc.dataset.commissionpayableId;
            const csrfToken = document.querySelector('meta[name="csrf-token"]').content;
            fetch(`/finance/accountreceivableview/${appId}`, { // Correct endpoint for receivables
                    method: 'POST',
                    headers: {
                    ...
                    body: JSON.stringify({
                        ...
                        value: newValue,
                        type: 'receivable',
                        commissionpayable_id: commissionPayableId // Correct payload key for receivables
                    })
                })
                .then(handleResponse)
                .then(data => {
        ...
        // ===================================================================
        // == UPDATED: PERFECT A4 PDF GENERATION SCRIPT
        // ===================================================================
        ...
        if (downloadBtn) {
            downloadBtn.addEventListener('click', async () => {
                ...
                if (allDocuments.length === 0) {
                    Swal.fire('No Invoices Found', 'There is nothing to download.', 'info');
                    return;
                }
                ...
                try {
                    ...
                    // UPDATE: Correct filename for this page
                    pdf.save(`WRI-Accounts-Receivable-${new Date().toISOString().slice(0,10)}.pdf`);
