...
class DataEntryApiController extends Controller
{
    ...
    {
        try {
            // Use 'distinct' to get only unique values and 'whereNotNull' to exclude empty ones.
            // We also order them alphabetically for a better user experience.
            $countries = DataEntry::distinct()->whereNotNull('country')->orderBy('country')->pluck('country');
            $universities = DataEntry::distinct()->whereNotNull('newUniversity')->orderBy('newUniversity')->pluck('newUniversity');
            $courses = DataEntry::distinct()->whereNotNull('newCourse')->orderBy('newCourse')->pluck('newCourse');
            $intakes = DataEntry::distinct()->whereNotNull('newIntake')->orderBy('newIntake')->pluck('newIntake');
